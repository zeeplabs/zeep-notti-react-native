...
/// `NuntisDeviceStore.kt` field-for-field so both platforms stay provably in
...
public class NuntisDeviceStore {

  private static let keyDeviceId = "nuntis_device_id"
  private static let keyLastToken = "nuntis_last_token"
  private static let keyExternalUserId = "nuntis_external_user_id"
  private static let keySubscribed = "nuntis_subscribed"
  private static let keyTags = "nuntis_tags"
  ...
  /// mirrors `NuntisDeviceStore.kt`'s `mergeTags`.
